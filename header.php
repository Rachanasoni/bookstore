...
<h4 id="welcometext">
	...
	echo 'Guest';
			 ...
			 ?></span> &nbsp;
			<i class="fa fa-user-circle" style="font-size:22px;"></i></h4>
	</div>
</header>
<section id="logobar">
	<div class="col-sm-6">
	...
	<div class="col-sm-6 text-right" id="preLoginBtns">
...
<section id="navlist">
	<div class="col-sm-12" id="navbar">
		<ul class="nav navbar-nav">
			...
			<li><a href="#about" onclick="associatedPage('about')">ABOUT US</a></li>
			<li><a href="#collection" onclick="associatedPage('collection')">COLLECTION</a></li>
			<li><a href="#newadd" onclick="associatedPage('newadd')">NEWLY ADDED</a></li>
			<li><a href="#popular" onclick="associatedPage('popular')">MOST POPULAR</a></li>
			<li><a href="#involved" onclick="associatedPage('involved')">GET INVOLVED</a></li>
